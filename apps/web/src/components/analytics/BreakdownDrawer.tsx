...
import { formatCurrencyDisplay, formatNumberDisplay, formatPercentageDisplay } from "@/lib/analytics-rendering";
            ...
            <div className="flex h-full flex-col">
              <div className="border-b border-border/60 px-5 py-5 sm:px-6">
                <div className="mb-4 flex items-start justify-between gap-4">
                  <div>
                    <p className="text-[11px] font-medium uppercase tracking-[0.24em] text-muted-foreground">Filtered Breakdown</p>
              ...
              <div className="flex-1 overflow-y-auto px-5 py-5 sm:px-6">
                <div className="mb-4 flex items-center gap-2">
                  ...
                  <h3 className="text-lg font-medium text-foreground">Filtered Trades</h3>
                </div>
                ...
                {loading ? (
                  ...
                  <div className="rounded-2xl border border-border/60 bg-background/70 px-4 py-10 text-center text-sm text-muted-foreground dark:bg-white/[0.03]">
                    No trades matched this slice yet.
                  </div>
                ) : (
                  <div className="space-y-3">
                    {trades.map((trade) => (
