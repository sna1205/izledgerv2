...
import { MAX_TRADE_SCREENSHOT_FILE_SIZE_BYTES, ScreenshotUploadError } from "@/lib/api/screenshots";
...
vi.mock("@/lib/api/screenshots", async () => {
  const actual = await vi.importActual<typeof import("@/lib/api/screenshots")>("@/lib/api/screenshots");
