    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-8 w-8 rounded-xl bg-background/70 p-0 text-foreground hover:bg-accent/60",
        ),
        nav_button_previous: "order-1",
        nav_button_next: "order-2",
        table: "w-full border-collapse",
        head_row: "flex",
        head_cell: "w-10 text-[11px] font-medium text-muted-foreground",
        row: "mt-1.5 flex w-full",
        cell: "relative h-10 w-10 p-0 text-center text-sm",
        day: cn(
          buttonVariants({ variant: "ghost" }),
          "h-10 w-10 rounded-xl p-0 text-sm font-medium text-foreground hover:bg-accent/55",
        ),
