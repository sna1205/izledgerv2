      ...
      <div className="flex h-full flex-col gap-5 pl-2">
          ...
          <div className="min-w-0 space-y-3">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm leading-6 text-muted-foreground" style={descriptionClampStyle}>
                {setup.description.trim() || "No summary added yet. Add one so this playbook is instantly recognizable when you tag a trade."}
              </p>
            </div>
          </div>
        ...
        <div className="rounded-[26px] border border-border/60 bg-background/65 p-4">
          <div className="mb-3 flex items-center justify-between gap-3">
            <p className="text-label">Strategy Rules</p>
          ...
          {ruleGroups.length > 0 ? (
            ...
            <p className="text-sm leading-6 text-muted-foreground">
              Entry, confirmation, and invalidation guidance will appear here once the playbook is defined.
            </p>
          )}
        </div>
